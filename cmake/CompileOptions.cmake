...
if (NOT DEFINED PARAM_READ_SET_CONT)
    message("PARAM_READ_SET_CONT is 0")
    add_definitions(-DPARAM_READ_SET_CONT=0)
elseif ((PARAM_READ_SET_CONT EQUAL 0) OR (PARAM_READ_SET_CONT EQUAL 1))
    message("PARAM_READ_SET_CONT is '${PARAM_READ_SET_CONT}'")
    add_definitions(-DPARAM_READ_SET_CONT=${PARAM_READ_SET_CONT})
else ()
    message(FATAL_ERROR "Setting of PARAM_READ_SET_CONT is invalid.")
endif()

if (NOT DEFINED PARAM_VAL_PRO)
    message("PARAM_VAL_PRO is 0")
    add_definitions(-DPARAM_VAL_PRO=0)
elseif ((PARAM_VAL_PRO EQUAL 0) OR (PARAM_VAL_PRO EQUAL 1))
    message("PARAM_VAL_PRO is '${PARAM_VAL_PRO}'")
    add_definitions(-DPARAM_VAL_PRO=${PARAM_VAL_PRO})
else ()
    message(FATAL_ERROR "Setting of PARAM_VAL_PRO is invalid.")
endif()

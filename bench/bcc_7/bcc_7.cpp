...
void init_google_logging() {
    google::InitGoogleLogging("/tmp/shirakami-bench-bcc_7");
...
int main(int argc, char* argv[]) try { // NOLINT
    ...
    log_dir.append("/tmp/shirakami_bench_bcc_7_log");

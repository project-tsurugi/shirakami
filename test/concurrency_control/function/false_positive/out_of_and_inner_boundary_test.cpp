...
class out_of_and_inner_boundary_test : public ::testing::Test { // NOLINT
public:
...
TEST_F(out_of_and_inner_boundary_test, out_of_boundary) { // NOLINT
    ...
    // ==========
    // note: o is occ, l is ltx, t1 is occ.
    // t2t3: ll
    ...
    ASSERT_EQ(Status::OK, search_key(s.at(1), stb, b, buf));
...
TEST_F(out_of_and_inner_boundary_test, inner_boundary) { // NOLINT
    ...
    // ==========
    // note: o is occ, l is ltx, t2 is occ.
    // t2t3: ll

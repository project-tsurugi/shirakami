...
class read_and_boundary_wait_read_abort_with_epoch_test
...
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-concurrency_control-function-"
                                  ...
                                  "wait_read_abort_with_epoch_test");
...
TEST_F(read_and_boundary_wait_read_abort_with_epoch_test, // NOLINT
       read_abort_with_epoch) {                           // NOLINT
                                                          // create table
    // ==========
    // prepare
    Storage sta{};

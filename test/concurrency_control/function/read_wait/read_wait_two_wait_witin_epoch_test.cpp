...
class read_wait_two_wait_within_epoch_test : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                "shirakami-test-concurrency_control-function-"
                "read_wait-read_wait_two_wait_within_epoch_test");
...
TEST_F(read_wait_two_wait_within_epoch_test, within_epoch) { // NOLINT
                                                             // create table
    // ==========
    // prepare
    Storage sta{};

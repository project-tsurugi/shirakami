...
class overlapped_4tx_with_epoch_cycled_test : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                "shirakami-test-concurrency_control-anomaly-"
                "write_crown-overlapped_4tx_with_epoch_cycled_test");
...
TEST_F(overlapped_4tx_with_epoch_cycled_test, all) { // NOLINT
                                                     // create table
    // ==========
    // prepare
    Storage sta{};

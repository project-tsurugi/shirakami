...
class cascading_3tx_1epoch_per_1ope_cycled_3_test
    : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                "shirakami-test-concurrency_control-anomaly-"
                "write_crown-cascading_3tx_1epoch_per_1ope_cycled_3_test");
...
TEST_F(cascading_3tx_1epoch_per_1ope_cycled_3_test, all) { // NOLINT

...
class overlapped_4tx_uncycled_3_test : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-concurrency_control-anomaly-"
                                  "write_crown-overlapped_4tx_uncycled_3_test");
...
TEST_F(overlapped_4tx_uncycled_3_test, all) { // NOLINT

...
class read_and_boundary_wait_boundary_abort_with_epoch_test
    : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-concurrency_control-function-"
                                  "read_and_boundary_wait-read_and_boundary_"
                                  "wait_boundary_abort_with_epoch_test");
...
TEST_F(read_and_boundary_wait_boundary_abort_with_epoch_test, // NOLINT
       boundary_abort_with_epoch) {                           // NOLINT
                                                              // create table
    // ==========
    // prepare
    Storage sta{};

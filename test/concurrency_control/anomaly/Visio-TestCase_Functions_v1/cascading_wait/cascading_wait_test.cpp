...
class cascading_wait_test : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-concurrency_control-function-"
                                  "cascading_wait-cascading_wait_test");
...
TEST_F(cascading_wait_test, lazy_update) { // NOLINT
                                           // create table
    // ==========
    // prepare
    Storage sta{};
...
TEST_F(cascading_wait_test, lazy_update_with_epoch) { // NOLINT
                                                      // create table
    // ==========
    // prepare
    Storage sta{};

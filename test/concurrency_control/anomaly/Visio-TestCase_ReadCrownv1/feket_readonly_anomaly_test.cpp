...
INSTANTIATE_TEST_SUITE_P(tx3_type, feket_readonly_anomaly_test,
...
TEST_P(feket_readonly_anomaly_test, all) { // NOLINT
    ...
    // lol
    // safe_read
    // lol (last ltx is read only)
    auto tx3_type = GetParam();
    auto [tx3_read_v, tx3_commit_rc] = tx3_type == transaction_options::transaction_type::LONG

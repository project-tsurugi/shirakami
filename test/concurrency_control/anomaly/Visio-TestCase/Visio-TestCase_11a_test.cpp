...
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                ...
                "anomaly-Visio-TestCase-Visio-Test'Case_11a_test");
...
INSTANTIATE_TEST_SUITE_P( // NOLINT
        ...
        ::testing::Values( // param and result list
                std::make_tuple(
                        transaction_type::SHORT, transaction_type::SHORT,
                        transaction_type::SHORT, transaction_type::SHORT,
                        transaction_type::SHORT, transaction_type::SHORT, false,
                ...
                std::make_tuple(transaction_type::SHORT,
                                ...
                                transaction_type::SHORT,
                                transaction_type::SHORT, transaction_type::LONG,
                                transaction_type::SHORT, false, false, true,
                                true, true,
                                true), // c3
                std::make_tuple(transaction_type::SHORT,
                                transaction_type::SHORT,
...
TEST_P(Visio_TestCase, test) { // NOLINT
    ...
    */
    ...
    if (t1_type == transaction_type::LONG || t2_type == transaction_type::LONG || t3_type == transaction_type::LONG || t4_type == transaction_type::LONG || t5_type == transaction_type::LONG || t6_type == transaction_type::LONG) { GTEST_SKIP() << "LONG is not supported"; }

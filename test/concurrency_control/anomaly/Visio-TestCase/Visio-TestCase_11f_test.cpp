...
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                ...
                "anomaly-Visio-TestCase-Visio-Test'Case_11f_test");
...
INSTANTIATE_TEST_SUITE_P( // NOLINT
        ...
        ::testing::Values( // param and result list
                ...
                std::make_tuple(transaction_type::LONG, transaction_type::LONG,
                                ...
                                transaction_type::SHORT,
                                transaction_type::SHORT,
                                transaction_type::SHORT, true, true, true, true,
                                false,
                                false), // c22
                ...
                std::make_tuple(transaction_type::SHORT,
                                transaction_type::SHORT, transaction_type::LONG,
                                transaction_type::SHORT, transaction_type::LONG,
                                transaction_type::LONG, false, false, true,
                                true, true,
                                true) // c24
                ));
    ...
    */
    ...
    if (!t6_was_finished) {
        if (t6_type == transaction_type::LONG) {
            while (!was_called_6) { spin_wait_hint(); }
        }
        if (t6_can_commit) {

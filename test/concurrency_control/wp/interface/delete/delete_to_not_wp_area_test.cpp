...
class delete_to_not_wp_area_test : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-concurrency_control-wp-"
                                  "delete_to_not_wp_area_test");
    ...
    void SetUp() override {
        ...
        log_dir.append("/build/delete_to_not_wp_area_test_log");
...
TEST_F(delete_to_not_wp_area_test, simple) { // NOLINT
    Storage st_1{};

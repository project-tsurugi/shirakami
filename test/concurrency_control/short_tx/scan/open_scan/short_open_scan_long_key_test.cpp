...
class short_open_scan_long_key : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-concurrency_control-short_tx-"
                                  "scan-short_open_scan_long_key_test");
...
TEST_F(short_open_scan_long_key, 35kb_key_open_scan) { // NOLINT
    // open_scan 35KB key
    Storage st{};
    create_storage("", st);
...
TEST_F(short_open_scan_long_key, 36kb_key_open_scan) { // NOLINT
    // open_scan 36KB key
    Storage st{};
    create_storage("", st);

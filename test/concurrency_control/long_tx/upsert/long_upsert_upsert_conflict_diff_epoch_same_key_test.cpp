...
class long_upsert_upsert_conflict_diff_epoch_same_key_test
    : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                "shirakami-test-concurrency_control-long_tx-"
                "upsert-long_upsert_upsert_conflict_diff_epoch_same_key_test");
...
TEST_F(long_upsert_upsert_conflict_diff_epoch_same_key_test, // NOLINT

...
class long_upsert_upsert_conflict_diff_epoch_diff_key_test
    : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                "shirakami-test-concurrency_control-long_tx-"
                "upsert-long_upsert_upsert_conflict_diff_epoch_diff_key_test");
...
TEST_F(long_upsert_upsert_conflict_diff_epoch_diff_key_test,    // NOLINT
       different_key_different_epoch_io_high_low_co_high_low) { // NOLINT
    /**
...
TEST_F(long_upsert_upsert_conflict_diff_epoch_diff_key_test,    // NOLINT
       different_key_different_epoch_io_low_high_co_high_low) { // NOLINT
    /**
     * There are two long tx.
     * They are different epoch.
     * They insert different (unique) key to the same storage.
...
TEST_F(long_upsert_upsert_conflict_diff_epoch_diff_key_test,    // NOLINT
       different_key_different_epoch_io_high_low_co_low_high) { // NOLINT
    /**
     * There are two long tx.
     * They are different epoch.
     * They insert different (unique) key to the same storage.
...
TEST_F(long_upsert_upsert_conflict_diff_epoch_diff_key_test,    // NOLINT
       different_key_different_epoch_io_low_high_co_low_high) { // NOLINT
    /**
     * There are two long tx.
     * They are different epoch.
     * They insert different (unique) key to the same storage.

...
class long_insert_insert_conflict_same_epoch_diff_key_test
    : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                "shirakami-test-concurrency_control-long_tx-"
                "insert-long_insert_insert_conflict_same_epoch_diff_key_test");
...
TEST_F(long_insert_insert_conflict_same_epoch_diff_key_test, // NOLINT
    ...
    ASSERT_EQ(insert(s2, st, pk2, ""), Status::OK);

...
class long_insert_insert_conflict_diff_epoch_same_key_co_high_low_test
...
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-concurrency_control-long_tx-"
                                  ...
                                  "epoch_same_key_co_high_low_test");
...
TEST_F(long_insert_insert_conflict_diff_epoch_same_key_co_high_low_test, // NOLINT
       io_low_high) { // NOLINT
    /**

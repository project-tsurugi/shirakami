...
class read_only_tx_state_metadata_test : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging(
                "shirakami-test-concurrency_control-read_only_tx-tx_state-"
                "read_only_tx_state_metadata_test");
...
TEST_F(read_only_tx_state_metadata_test,      // NOLINT
       read_only_before_after_commit_abort) { // NOLINT
    Token s{};

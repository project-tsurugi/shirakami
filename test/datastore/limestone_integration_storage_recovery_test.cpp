...
class limestone_integration_storage_recovery_test
    : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-data_store-"
                                  "limestone_integration_storage_recovery_test");
...
TEST_F(limestone_integration_storage_recovery_test, registered_storage_with_no_records) { // NOLINT

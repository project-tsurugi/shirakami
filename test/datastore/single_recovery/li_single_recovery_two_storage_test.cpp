...
class li_single_recovery_two_storage_test : public ::testing::Test { // NOLINT
public:
    static void call_once_f() {
        google::InitGoogleLogging("shirakami-test-data_store-"
                                  "li_single_recovery_two_storage_test");
...
TEST_F(li_single_recovery_two_storage_test,             // NOLINT

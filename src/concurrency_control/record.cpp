...
Record::Record(Storage st, std::string_view const key) : key_(key), storage_(st) {
...
Record::Record(Storage st, std::string_view const key, std::string_view const val)
    : key_(key), storage_(st) {

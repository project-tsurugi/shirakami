...
Status scan_key([[maybe_unused]] Token token, [[maybe_unused]] Storage storage,
                [[maybe_unused]] const std::string_view l_key,
                [[maybe_unused]] const scan_endpoint l_end, // NOLINT
                [[maybe_unused]] const std::string_view r_key,
                [[maybe_unused]] const scan_endpoint r_end,
                [[maybe_unused]] std::vector<const Tuple*>& result,
                [[maybe_unused]] std::size_t const max_size) {
    return Status::OK;
}
